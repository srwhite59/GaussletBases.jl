...
public_inputs = (
    ...
    :gausslet_family, :basisname, :lmax, :uncontracted,
...
if vars[:print_contract]
    ...
    println("basis: q=", vars[:q], " core_spacing=", vars[:core_spacing], " padding=", vars[:padding], " gausslet_family=", vars[:gausslet_family])

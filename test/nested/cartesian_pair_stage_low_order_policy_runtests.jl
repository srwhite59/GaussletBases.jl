...
# Integration gate, not a per-pass gate. This test builds full staged Cartesian
# routes; use cartesian_pair_stage_fingerprint_helpers_runtests.jl for the tiny
# per-pass fingerprint contract.

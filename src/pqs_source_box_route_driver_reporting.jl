...
function _pqs_source_box_route_driver_write_pqs_diatomic_readiness_artifact!(
    ...
    _pqs_source_box_route_driver_write_present_group!(
        ...
        (;
            ...
            endpoint_blocker = get(recipe, :physics_endpoint_blocker, nothing),

...
function _pqs_source_box_route_driver_private_global_overlap_placement_plan_skeleton(
    ...
    placement_plan_review_status =
        collection_available ?
        _pqs_source_box_route_driver_private_global_overlap_placement_plan_review_status(
            placement_plan,
        ) :
        :unavailable
    placement_plan_blocker =
        collection_available ?
        _pqs_source_box_route_driver_private_global_overlap_placement_plan_blocker(
            placement_plan,
        ) :
        :unavailable
    placement_plan_is_reviewed =
        collection_available &&
        _pqs_source_box_route_driver_private_global_overlap_placement_plan_is_reviewed(
            placement_plan,
        )
    accumulation_rule_status =
        collection_available ?
    ...
    record_placement_summaries = Tuple(
        _pqs_source_box_route_driver_private_global_overlap_record_placement_summary(
            record_summary,
            retained_transform_status,
            left_column_range_status,
            right_column_range_status,
    ...
    return (;
        ...
        placement_plan_kind =
            isnothing(placement_plan) ?
            :unavailable :
            _pqs_source_box_route_driver_private_global_overlap_placement_plan_kind(
                placement_plan,
            ),
        placement_plan_review_status,
        placement_plan_blocker,
        ...
        accumulation_rule_status,
        accumulation_rule = isnothing(accumulation_rule) ? :unavailable : accumulation_rule,
        available_requirements,
        missing_requirements,
...
function _pqs_source_box_route_driver_private_global_overlap_record_placement_summary(
    ...
    return (;
        ...
        source_kind = record_summary.source_kind,
        dense_block_available = record_summary.dense_block_available,
        dense_block_shape = record_summary.dense_block_shape,
        left_cpb_summary = record_summary.left_cpb_summary,
        right_cpb_summary = record_summary.right_cpb_summary,
...
function _pqs_source_box_route_driver_private_global_overlap_placement_plan_kind(
    ...
    if placement_plan isa Symbol
        return placement_plan
    end
    kind = _pqs_source_box_route_driver_private_global_overlap_property(
        placement_plan,
        :kind,
    )
    isnothing(kind) || return kind
    return :provided_overlap_placement_plan_placeholder
end

function _pqs_source_box_route_driver_private_global_overlap_placement_plan_review_status(
    placement_plan,
)
    isnothing(placement_plan) && return :missing_placement_plan
    plan_summary =
        _pqs_source_box_route_driver_private_global_overlap_placement_plan_summary(
            placement_plan,
        )
    _pqs_source_box_route_driver_private_global_overlap_placement_plan_is_reviewed(
        placement_plan,
...
function _pqs_source_box_route_driver_private_global_overlap_placement_plan_blocker(
    placement_plan,
)
    isnothing(placement_plan) && return :missing_placement_plan
    plan_summary =
...
function _pqs_source_box_route_driver_private_global_overlap_placement_plan_is_reviewed(
    placement_plan,
    plan_summary =
        _pqs_source_box_route_driver_private_global_overlap_placement_plan_summary(
            placement_plan,
    ...
    placement_plan isa CartesianCPBBlockProviders.CPBReviewedOverlapPlacementPlan &&
        return true
    ...
    return plan_status in (
        :available_cpb_reviewed_overlap_placement_plan,
        :blocked_cpb_reviewed_overlap_placement_plan,
    )
end

function _pqs_source_box_route_driver_private_global_overlap_placement_plan_summary(
    placement_plan,
)
    placement_plan isa CartesianCPBBlockProviders.CPBReviewedOverlapPlacementPlan &&
        return CartesianCPBBlockProviders.summary(placement_plan)
...
function _pqs_source_box_route_driver_private_global_overlap_property(
    ...
    return hasproperty(object, key) ? getproperty(object, key) : default
end
...
function _pqs_source_box_route_driver_diatomic_complete_core_shell_source_plan_payload(
    ...
    elseif system_classification !== :bond_aligned_diatomic
        ...
        missing =
            source_realization_payload_status ===
            :available_diatomic_complete_core_shell_source_realization ?
            Symbol[:pqs_multilayer_shell_source_plan_adapter_contract] :

...
include("foundation/lanczos.jl")
include("ordinary/ordinary_coulomb.jl")
include("ordinary/ordinary_pgdg.jl")
include("ordinary/ordinary_pgdg_refinement_masks.jl")
include("ordinary/ordinary_hybrid.jl")
include("ordinary/legacy_basis_adapter.jl")
include("ordinary/ordinary_mapped_backends.jl")
include("ordinary/ordinary_sho.jl")
include("ordinary/ordinary_cartesian_ida.jl")
include("cartesian/cartesian_nested_faces.jl")
include("cartesian/cartesian_nested_owned_units.jl")
include("cartesian/cartesian_nested_atomic.jl")
include("cartesian/cartesian_nested_diatomic.jl")
include("cartesian/cartesian_cpb/CartesianCPB.jl")
include("cartesian/cartesian_raw_product_sources/CartesianRawProductSources.jl")
include("cartesian/cartesian_residual_gaussians/CartesianResidualGaussians.jl")
include("cartesian/cartesian_gaussian_raw_blocks/CartesianGaussianRawBlocks.jl")
include("cartesian/cartesian_final_basis_realization/CartesianFinalBasisRealization.jl")
include("cartesian/cartesian_route_core/CartesianRouteCore.jl")
include("cartesian/cartesian_terminal_shellification_geometry.jl")
include("cartesian/cartesian_shellification/CartesianShellification.jl")
include("cartesian/cartesian_terminal_lowering/CartesianTerminalLowering.jl")
include("cartesian/cartesian_retained_units/CartesianRetainedUnits.jl")
include("cartesian/cartesian_retained_unit_transform_contracts/CartesianRetainedUnitTransformContracts.jl")
include("cartesian/cartesian_pair_block_materialization/CartesianPairBlockMaterialization.jl")
include("cartesian/cartesian_nested_experimental_geometries.jl")
include("cartesian/cartesian_gaussian_axis_integrals.jl")
include("cartesian/cartesian_ida_hamiltonian.jl")
include("ordinary/ordinary_qw_types_and_bases.jl")
include("cartesian/CartesianParentGaussletBases.jl")
include("cartesian/pqs_source_box_route_driver_helpers.jl")
include("cartesian/pqs_source_box_low_order_materialization.jl")
include("cartesian/cartesian_base_hamiltonian.jl")
include("cartesian/pqs_matched_h2plus.jl")
include("cartesian/cartesian_reference_density/CartesianReferenceDensity.jl")
using .CartesianReferenceDensity: ExactRepresentedHartreeField,
                                  ...
                                  screened_hartree_consistency_error,
                                  screened_hartree_field_kind
include("cartesian/pqs_source_box_diatomic_complete_core_shell.jl")
include("cartesian/pqs_source_box_route_driver_skeletons.jl")
include("ordinary/ordinary_qw_nested_frontends.jl")
include("ordinary/ordinary_qw_residuals.jl")
include("ordinary/ordinary_qw_raw_blocks.jl")
include("ordinary/ordinary_qw_operator_assembly.jl")
include("ordinary/ordinary_qw_corrections.jl")
include("cartesian/cartesian_basis_representation.jl")
include("cartesian/cartesian_cross_overlap.jl")
include("cartesian/cartesian_representation_constructors.jl")
include("cartesian/cartesian_representation_transfer.jl")
include("cartesian/cartesian_protected_ladder_bundle.jl")
include("cartesian/cartesian_gto_probes.jl")
include("cartesian/cartesian_external_gto_import.jl")
include("cartesian/cartesian_external_gto_interchange.jl")
include("cartesian/cartesian_qw_hybrid_representation.jl")
include("cartesian/gaussian_coulomb_reference.jl")
include("cartesian/hamiltonian_corrections.jl")
include("cartesian/bond_aligned_diatomic_geometry.jl")
...
include("ordinary/sliced_hydrogen_chain.jl")
include("atomic/atomic_ylm.jl")
include("radial/radial_ylm_gto_bridge.jl")
include("atomic/gaunt_tables.jl")
include("angular/angular_point_sets.jl")
include("angular/angular_shell_basis.jl")
include("angular/angular_shell_assembly.jl")
include("angular/angular_atomic_benchmark.jl")
include("atomic/atomic_angular_sectors.jl")
include("atomic/atomic_ida.jl")
include("atomic/atomic_ida_direct.jl")
include("atomic/atomic_ida_exchange.jl")
include("atomic/atomic_ida_fock.jl")
include("atomic/atomic_ida_uhf.jl")
include("atomic/atomic_ida_two_electron.jl")
include("atomic/fullida_dense_export.jl")
include("angular/angular_sequence_export.jl")
include("atomic/sliced_ham_export.jl")

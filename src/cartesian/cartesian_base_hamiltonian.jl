...
"""
    cartesian_residual_gto_mwg_system(working, z, Z; supplement, expansion, residual_occupation_cutoff=1e-8)
...
`residual_occupation_cutoff` defaults to 1e-8; its Float64 value must be finite

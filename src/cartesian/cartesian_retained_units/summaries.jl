...
function _retained_unit_plan_summary(
    ...
    return (;
        ...
        lowering_policy_kind =
            CartesianTerminalLowering.summary(lowering_plan).policy_kind,
        selected_contract_count =
            length(CartesianTerminalLowering.selected_contracts(lowering_plan)),
        ...
        route_core_final_unit_count =
            count(!isnothing(unit.route_core_final_unit) for unit in planned_units),

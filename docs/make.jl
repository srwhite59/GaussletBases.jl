...
makedocs(
    ...
    pages = [
        ...
        hide("Cartesian PQS and IDA overview" => "algorithms/cartesian_ida_overview.md"),
        hide("Cartesian low-dimensional operator assembly" => "algorithms/cartesian_low_dimensional_operator_assembly.md"),
        hide("PQS shell construction" => "algorithms/pqs_shell_construction.md"),
        hide("Residual-Gaussian extension" => "algorithms/residual_gaussian_extension.md"),
        hide("IDA Hamiltonian and counterpoise" => "algorithms/ida_hamiltonian_and_counterpoise.md"),

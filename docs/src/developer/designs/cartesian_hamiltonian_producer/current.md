...
| `HP-SLICE-HCHAIN-*` | Implemented/completed maintenance | Preserve the five-export compact G10-times-transverse producer, stable consumer fields, analytic Galerkin H1, longitudinal IntegralDiagonal Vee, allocation-free operator access, and checked long-range continuations; no solver or dense matrices |

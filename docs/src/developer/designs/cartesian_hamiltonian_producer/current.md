...
| `HP-PQS-PUBLIC-RC1-*` | `v0.2.0-rc1` candidate prepared at `41fa897ae`; clean validation completed; maintenance | Preserve the exact candidate version and concise reader changelog; tagging, GitHub release publication, registration, citation metadata, and final-release decisions require separate authority |

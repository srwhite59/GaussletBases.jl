...
| `HP-PUBLIC-FUNCTION-STENCIL-DOC-*` | Function-evaluation/stencil documentation approved; implementation pending | Document only the nine existing evaluation, center, integral, and stencil-introspection generics in their declarations and existing reference page; require exact `61 -> 52` undocumented-export reduction without changing behavior or global docs policy |

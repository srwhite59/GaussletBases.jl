...
| `HP-SLICE-HCHAIN-*` | Approved for implementation | Build one compact G10-times-paper-transverse hydrogen-chain producer with full analytic H1, longitudinal IntegralDiagonal Vee, finite/periodic lazy access, and validated H10000-range Coulomb tails; no solver or dense matrices |

...
| `HP-PQS-PUBLIC-*` | Narrow v0.2 matched-H2+ and supplied-field screened-Hartree interfaces approved; implementation pending | Add only the frozen `12789/1285/1285` comparison, typed exact/fitted field assembly, bounded examples, and ordinary/release gates in the [public-surface contract](pqs_public_surface.md); no fitting, packet, stage, solver, Ximg/XHF, or release-tag work |

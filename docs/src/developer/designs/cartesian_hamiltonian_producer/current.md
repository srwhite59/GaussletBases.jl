...
| `HP-PQS-PUBLIC-V020-*` | Direct final-candidate preparation approved; no RC3, tag, or release authority | Change only version/changelog/README and focused docs tests; retain the modest package claim, separate PQS and screening surfaces, full candidate gates, immutable RC history, and exact-hash freeze before any conditional publication grant |

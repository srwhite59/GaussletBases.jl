...
maintenance. Combined P0/q0, thresholds, ownership and other builders remain
unchanged. The packet-specific net-positive exception is consumed. Bounded
allocation savings are not peak-RSS admission: q9 remains blocked on prior
garbage/lifetime accounting. Hchain-doer stays paused; no heavy acceptance,
HF, lifetime change or successor implementation is granted.
...
Pass 643 accepts [residual cutoff forwarding](pqs_residual_gto_working_basis.md#Collinear-Residual-Cutoff-Forwarding)
at 7f9dbfd1e and the shared-default correction b64499918. All four defaults
are 1e-8; explicit 1e-10/1e-6 choices, stored recipes and validity thresholds
are preserved. HP-COLLINEAR-PQS-RG-FN-01/TEST-01 return to maintenance.
The existing H10 208/210-direction evidence qualifies selection, not complete
operators, screening or HF. Hchain-doer still needs a separate bounded
continuation at 1e-8, reusing the saved standard-q5 basis and preserving 208 evidence.
...
maintain that connection and the accepted Pass 643 forwarding/default contract.

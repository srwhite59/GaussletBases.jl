...
| `HP-SLICE-HCHAIN-*` | Approved after implementation preflight | Build from a bounded authoritative G10 prototype and retain only its translated stencil for the full chain; provide full analytic H1, longitudinal IntegralDiagonal Vee, finite/periodic lazy access, and validated H10000-range H1/Vee tails; no solver or dense matrices |

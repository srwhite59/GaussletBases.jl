...
| --- | --- | --- |
| `HP-AUTHORITY-EXECUTION-WHITELIST-*` | Whole-file views maintained; bounded root-doc path amendment approved | Pass 601 permits only checker acceptance of existing DESIGN.md, ROADMAP.md, and STATUS.md documentation paths; preserve planned-state and all other fail-closed rules. Status/onboarding reader edits remain ungranted pending review |

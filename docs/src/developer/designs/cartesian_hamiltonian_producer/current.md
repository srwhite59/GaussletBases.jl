...
| `HP-RETIRE-CONTRACTED-PARENT-*` | Approved retirement | Delete the no-caller contracted-parent/multilayer route, obsolete IDA testset, and three tracked probes exactly; preserve all current parent, terminal, PQS/WL, PRF, pair, raw-block, represented-Hartree, and IDA owners |

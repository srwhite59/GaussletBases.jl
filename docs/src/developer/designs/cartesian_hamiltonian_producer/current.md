...
| `HP-RETIRE-PAIR-LADDER-*` | Approved retirement | Delete the orphaned unit-pair/pair-plan/materialization ladder while preserving the mapped-COMX axis-transform helper in place; require mapped-COMX parity and at least approximately 9,900 net source lines removed |

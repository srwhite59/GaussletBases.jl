...
| `HP-PUBLIC-PAPER-CI-*` | Three-gate paper-aligned CI approved, not implemented | Add separate Julia `1.12` PQS and screening release groups beside the unchanged Julia `1.10` supported-floor gate; relocate, do not duplicate, the public screening testset and leave nested research suites unwired |

...
| `HP-PQS-PUBLIC-*` | Matched-H2+ and supplied-field screened-Hartree public surfaces implemented; validation completed | Maintain the frozen `12789/1285/1285` comparison, typed exact/fitted field assembly, bounded examples, and ordinary/release gates in the [public-surface contract](pqs_public_surface.md); a clean candidate replay remains required before any release tag |

...
- R3-B residual-GTO/MWG in-memory interaction reapproval after the
  compact-path baseline correction;
- residual-GTO/MWG work outside the approved R3-A first H2 path, including
  artifacts and broader consumers;

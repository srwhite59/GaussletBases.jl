...
| Old fixed-block / materialized seed safe one-body paths | Oracle for selected White--Lindsey local/global safe one-body checks. | Local one-body block collection plus term-specific placement plans and global retained matrices. | `test/nested/cartesian_pair_block_global_overlap_oracle_runtests.jl` covers selected old-oracle overlap slices through `White-Lindsey local adapter overlap blocks -> local one-body block collection -> overlap placement plan -> global overlap matrix`: face/face `162:170, 162:170`, face/edge `162:170, 210:212`, and transpose-filled edge/face `210:212, 162:170`. Observed max absolute errors were `1.7636953211319766e-15`, `2.6343504968563524e-46`, and `2.6343504968563524e-46`, respectively. `test/nested/cartesian_pair_block_global_kinetic_oracle_runtests.jl` covers selected White--Lindsey global kinetic equivalence through `White-Lindsey local adapter kinetic blocks -> local one-body block collection -> kinetic placement plan -> global kinetic matrix` on the same slices. Observed kinetic max absolute errors were `3.4638958368304884e-14`, `3.1907967999947086e-30`, and `3.1907967999947086e-30`, respectively. `test/nested/cartesian_pair_block_global_position_oracle_runtests.jl` covers selected global `position_x`, `position_y`, and `position_z` equivalence through `White-Lindsey local adapter position blocks -> local one-body block collection -> position placement plan -> global position matrix` on the same slices. Observed position_x max absolute errors were `1.7435358081325719e-15`, `9.857551802004026e-46`, and `9.857551802004026e-46`; position_y errors were `8.459873058838228e-16`, `8.758115402030107e-46`, and `8.758115402030107e-46`; position_z errors were `8.474501317837309e-16`, `4.926439913641935e-47`, and `4.926439913641935e-47`. `test/nested/cartesian_pair_block_global_x2_oracle_runtests.jl` covers selected global `x2_x` equivalence through `White-Lindsey local adapter x2_x blocks -> local one-body block collection -> x2_x placement plan -> global x2_x matrix` on the same slices. Observed x2_x max absolute errors were `1.844473375912524e-15`, `6.0243961376664915e-34`, and `6.0243961376664915e-34`, respectively. Synthetic global retained matrix pilots now exist for `:overlap`, `:kinetic`, `:position_x`, `:position_y`, `:position_z`, `:x2_x`, `:x2_y`, and `:x2_z`; x2_y and x2_z currently have synthetic placement/global-matrix coverage only, not old-oracle equivalence. | oracle; selected global overlap/kinetic/position/x2_x equivalence covered; synthetic safe one-body global pilots active | Full retirement still requires broader focused equivalence tests covering retained-unit inventory, local blocks, placement, and global safe one-body assembly. | This is selected-slice overlap, kinetic, position, and x2_x equivalence plus synthetic safe one-body global assembly coverage, not full-route replacement. Keep the old path as validation authority. X2_y and x2_z are not oracle-covered yet. No driver integration, Hamiltonian assembly, term summing, Coulomb, IDA/MWG, PQS projection/Lowdin, exports, or artifacts are claimed here. |
...
- Selected global overlap, kinetic, position_x, position_y, position_z, and
  x2_x equivalence are now covered for White--Lindsey face/face and face/edge
  slices.
...
- Selected White--Lindsey old-oracle equivalence currently covers overlap,
  kinetic, position_x, position_y, position_z, and x2_x only. X2_y and x2_z
  have synthetic placement/global-matrix coverage but no old-oracle
  equivalence coverage yet.
...
- The next replacement slice should add selected old-oracle equivalence for
  x2_y or x2_z before driver wiring.

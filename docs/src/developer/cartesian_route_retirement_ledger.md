...
- Selected global overlap and kinetic equivalence are now covered for
  White--Lindsey face/face and face/edge slices.
- Synthetic global retained matrix pilots now exist for the safe one-body
  ...
  `:x2_x`, `:x2_y`, and `:x2_z`.
- Selected White--Lindsey old-oracle equivalence currently covers overlap and
  kinetic only. Position and x2 have synthetic placement/global-matrix
  coverage but no old-oracle equivalence coverage yet.
...
- The next replacement slice should add selected old-oracle equivalence for one
  position or x2 term before driver wiring.

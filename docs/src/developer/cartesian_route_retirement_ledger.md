...
- Selected global overlap, kinetic, and position_x equivalence are now covered
  for White--Lindsey face/face and face/edge slices.
...
- Selected White--Lindsey old-oracle equivalence currently covers overlap,
  kinetic, and position_x only. Position_y, position_z, and x2 have synthetic
...
- The next replacement slice should add selected old-oracle equivalence for
  position_y, position_z, or one x2 term before driver wiring.

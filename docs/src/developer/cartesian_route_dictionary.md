...
global overlap, kinetic, position_x, position_y, position_z, and x2_x only.
X2_y and x2_z have synthetic placement/global-matrix coverage but no
old-oracle equivalence coverage yet.

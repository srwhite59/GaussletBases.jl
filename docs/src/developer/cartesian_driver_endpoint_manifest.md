...
| `test/driver_inputs/h2_pqs_q5_physical_gausslet_r4.jl` | `test/nested/cartesian_ham_builder_h2_pqs_q5_physical_gausslet_r4_target_runtests.jl` | H2 PQS q5 physical gausslet target inventory | 463 expected | no | `:missing_physical_gausslet_rhf_execution_adapter` | no |
